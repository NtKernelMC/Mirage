...
#include "NetAPI/bitstream.h"
#include "NetAPI/utils/SharedUtil.Game.h"
#include "NetAPI/utils/SharedUtil.Misc.h"
//#include "CVector2D.h"
...
struct SWeaponAimSync : public ISyncStructure
{
    ...
    bool Read(NetBitStreamInterface& bitStream)
    {
        ...
        if (m_bFull && bStatus)
        {
            ...
            {
                data.vecTarget = CVector();
                data.vecOrigin = data.vecTarget;
            }
        }
