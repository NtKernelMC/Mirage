...
// Р В РІР‚СљР В Р’В»Р В РЎвЂўР В Р’В±Р В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р РЋРІР‚в„–Р В Р’Вµ Р В РЎвЂ”Р В Р’ВµР РЋР вЂљР В Р’ВµР В РЎпїЅР В Р’ВµР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В Р’Вµ Р В РўвЂ�Р В Р’В»Р РЋР РЏ Р РЋРІР‚В¦Р РЋР вЂљР В Р’В°Р В Р вЂ¦Р В Р’ВµР В Р вЂ¦Р В РЎвЂ�Р РЋР РЏ Р В Р’В·Р В Р’В°Р В РЎвЂ“Р РЋР вЂљР РЋРЎвЂњР В Р’В¶Р В Р’ВµР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р РЋРІР‚В¦ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™Р В РЎвЂўР В Р вЂ 
// Р В РІР‚в„ўР В Р’В°Р В Р’В¶Р В Р вЂ¦Р В РЎвЂў: Р РЋРІР‚В¦Р РЋР вЂљР В Р’В°Р В Р вЂ¦Р В РЎвЂ�Р В РЎпїЅ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™Р РЋРІР‚в„– Р В РЎвЂ“Р В Р’В»Р В РЎвЂўР В Р’В±Р В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р В РЎвЂў, Р РЋРІР‚РЋР РЋРІР‚С™Р В РЎвЂўР В Р’В±Р РЋРІР‚в„– Р В РЎвЂўР В Р вЂ¦Р В РЎвЂ� Р В Р вЂ¦Р В Р’Вµ Р РЋРЎвЂњР В РўвЂ�Р В Р’В°Р В Р’В»Р РЋР РЏР В Р’В»Р В РЎвЂ�Р РЋР С“Р РЋР Р‰ Р В РЎвЂ”Р В РЎвЂўР РЋР С“Р В Р’В»Р В Р’Вµ Р В Р вЂ Р РЋРІР‚в„–Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂ�Р В Р’В° Р В РЎвЂ�Р В Р’В· Р РЋРІР‚С›Р РЋРЎвЂњР В Р вЂ¦Р В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р В РЎвЂ�
static std::unordered_map<std::string, std::string> loaded_custom_scripts;
static std::mutex scripts_mutex; // Р В РІР‚СњР В Р’В»Р РЋР РЏ Р В РЎвЂ”Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂўР В РЎвЂќР В РЎвЂўР В Р’В±Р В Р’ВµР В Р’В·Р В РЎвЂўР В РЎвЂ”Р В Р’В°Р РЋР С“Р В Р вЂ¦Р В РЎвЂўР РЋР С“Р РЋРІР‚С™Р В РЎвЂ�
...
{
    // Р В РІР‚в„ўР В РЎвЂўР РЋР С“Р РЋР С“Р РЋРІР‚С™Р В Р’В°Р В Р вЂ¦Р В Р’В°Р В Р вЂ Р В Р’В»Р В РЎвЂ�Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В Р’В»Р В РЎвЂўР В РЎвЂ“/Р РЋРЎвЂњР В РўвЂ�Р В Р’В°Р В Р’В»Р РЋР РЏР В Р’ВµР В РЎпїЅ HWBP, Р В Р’ВµР РЋР С“Р В Р’В»Р В РЎвЂ� Р В Р вЂ¦Р В Р’ВµР В РЎвЂўР В Р’В±Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂ�Р В РЎвЂ�Р В РЎпїЅР В РЎвЂў
    ...
    // Р В РЎвЂєР В Р’В±Р РЋР вЂљР В Р’В°Р В Р’В±Р В РЎвЂўР РЋРІР‚С™Р В РЎвЂќР В Р’В° Р В РўвЂ�Р В Р’В°Р В РЎпїЅР В РЎвЂ”Р В Р’ВµР РЋР вЂљР В Р’В°
    if (mirage.Dumper)
    {
        if (name == nullptr)
        {
    ...
    // Р В Р’В¤Р В Р’В»Р В Р’В°Р В РЎвЂ“ Р В РўвЂ�Р В Р’В»Р РЋР РЏ Р В РЎвЂўР В РЎвЂ”Р РЋР вЂљР В Р’ВµР В РўвЂ�Р В Р’ВµР В Р’В»Р В Р’ВµР В Р вЂ¦Р В РЎвЂ�Р РЋР РЏ, Р В Р’В±Р РЋРІР‚в„–Р В Р’В»Р В Р’В° Р В Р’В»Р В РЎвЂ� Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В РЎвЂ�Р В Р’В·Р В Р вЂ Р В Р’ВµР В РўвЂ�Р В Р’ВµР В Р вЂ¦Р В Р’В° Р В Р’В·Р В Р’В°Р В РЎпїЅР В Р’ВµР В Р вЂ¦Р В Р’В°
    bool script_replaced = false;

    // Р В РІР‚СћР РЋР С“Р В Р’В»Р В РЎвЂ� Р В РЎвЂ�Р В РЎпїЅР РЋР РЏ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™Р В Р’В° Р В Р’В·Р В Р’В°Р В РўвЂ�Р В Р’В°Р В Р вЂ¦Р В РЎвЂў Р В РЎвЂ� Р В Р’ВµР РЋР С“Р РЋРІР‚С™Р РЋР Р‰ Р В Р’В·Р В Р’В°Р В РЎвЂ”Р В РЎвЂ�Р РЋР С“Р В РЎвЂ� Р В РўвЂ�Р В Р’В»Р РЋР РЏ Р В РЎвЂ�Р В Р вЂ¦Р РЋР вЂ°Р В Р’ВµР В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р В РЎвЂ�
    if (name && !lua_injection_list.empty())
    {
        ...
        for (const auto& lvm : lua_injection_list)
        {
                ...
                std::wstring(lvm.target_script.begin(), lvm.target_script.end())))
            {
                ...
                // Р В Р Р‹Р В РЎвЂўР В Р’В·Р В РўвЂ�Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В Р вЂ Р РЋР вЂљР В Р’ВµР В РЎпїЅР В Р’ВµР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р В Р’В±Р РЋРЎвЂњР РЋРІР‚С›Р В Р’ВµР РЋР вЂљ Р В РўвЂ�Р В Р’В»Р РЋР РЏ Р РЋРІР‚РЋР РЋРІР‚С™Р В Р’ВµР В Р вЂ¦Р В РЎвЂ�Р РЋР РЏ
                ...
                // Р В РІР‚СњР В Р’ВµР В РЎвЂќР В РЎвЂўР В РўвЂ�Р В РЎвЂ�Р РЋР вЂљР РЋРЎвЂњР В Р’ВµР В РЎпїЅ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™
                ...
                // Р В РЎв„ўР В РЎвЂўР В Р вЂ¦Р В Р вЂ Р В Р’ВµР РЋР вЂљР РЋРІР‚С™Р В РЎвЂ�Р РЋР вЂљР РЋРЎвЂњР В Р’ВµР В РЎпїЅ Р В Р вЂ  UTF-8 Р В Р’ВµР РЋР С“Р В Р’В»Р В РЎвЂ� Р В Р вЂ¦Р В Р’ВµР В РЎвЂўР В Р’В±Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂ�Р В РЎвЂ�Р В РЎпїЅР В РЎвЂў
                if (!IsUtf8(temp_script))
                {
                    temp_script = cp1251_to_utf8(temp_script.c_str());
                }

                // Р В Р Р‹Р В РЎвЂўР РЋРІР‚В¦Р РЋР вЂљР В Р’В°Р В Р вЂ¦Р РЋР РЏР В Р’ВµР В РЎпїЅ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™ Р В Р вЂ  Р В РЎвЂ“Р В Р’В»Р В РЎвЂўР В Р’В±Р В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р В РЎвЂўР В РЎпїЅ Р РЋРІР‚В¦Р РЋР вЂљР В Р’В°Р В Р вЂ¦Р В РЎвЂ�Р В Р’В»Р В РЎвЂ�Р РЋРІР‚В°Р В Р’Вµ
                {
                    std::lock_guard<std::mutex> lock(scripts_mutex);
                    loaded_custom_scripts[script_name] = std::move(temp_script);
                }

                // Р В РЎСџР В РЎвЂўР В Р’В»Р РЋРЎвЂњР РЋРІР‚РЋР В Р’В°Р В Р’ВµР В РЎпїЅ Р РЋР С“Р РЋР С“Р РЋРІР‚в„–Р В Р’В»Р В РЎвЂќР РЋРЎвЂњ Р В Р вЂ¦Р В Р’В° Р РЋР С“Р В РЎвЂўР РЋРІР‚В¦Р РЋР вЂљР В Р’В°Р В Р вЂ¦Р В Р’ВµР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™
                auto& stored_script = loaded_custom_scripts[script_name];

                // Р В РІР‚в„ўР РЋРІР‚в„–Р В Р’В·Р РЋРІР‚в„–Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В РЎвЂўР РЋР вЂљР В РЎвЂ�Р В РЎвЂ“Р В РЎвЂ�Р В Р вЂ¦Р В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р РЋРЎвЂњР РЋР вЂ№ Р РЋРІР‚С›Р РЋРЎвЂњР В Р вЂ¦Р В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р РЋР вЂ№ Р РЋР С“ Р В Р вЂ¦Р В Р’В°Р РЋРІвЂљВ¬Р В РЎвЂ�Р В РЎпїЅ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™Р В РЎвЂўР В РЎпїЅ
                injected_count++;
                ...
                // Р В РІР‚в„ўР В РЎвЂўР РЋР С“Р РЋР С“Р РЋРІР‚С™Р В Р’В°Р В Р вЂ¦Р В Р’В°Р В Р вЂ Р В Р’В»Р В РЎвЂ�Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р РЋРІР‚В¦Р РЋРЎвЂњР В РЎвЂќ Р В РЎвЂ”Р В Р’ВµР РЋР вЂљР В Р’ВµР В РўвЂ� Р В Р вЂ Р РЋРІР‚в„–Р В Р’В·Р В РЎвЂўР В Р вЂ Р В РЎвЂўР В РЎпїЅ
                ...
                // Р В РІР‚в„ўР РЋРІР‚в„–Р В Р’В·Р РЋРІР‚в„–Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р РЋР С“ Р В Р вЂ¦Р В Р’В°Р РЋРІвЂљВ¬Р В РЎвЂ�Р В РЎпїЅ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™Р В РЎвЂўР В РЎпїЅ
                return callLuaLoadBuffer(L, (char*)stored_script.data(), stored_script.size(), name);
            }
        }
    }

    // Р В РІР‚в„ўР В РЎвЂўР РЋР С“Р РЋР С“Р РЋРІР‚С™Р В Р’В°Р В Р вЂ¦Р В Р’В°Р В Р вЂ Р В Р’В»Р В РЎвЂ�Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р РЋРІР‚В¦Р РЋРЎвЂњР В РЎвЂќ
    if (mirage.hwbp_hooking == HookingType::HWBP_HOOK && !hwbp_end1)
        HWBP::InstallHWBP((DWORD)callLuaLoadBuffer, (DWORD)&hkLuaLoadBuffer);
    if (mirage.hwbp_hooking == HookingType::INLINE_JUMP)
        MakeJump((DWORD)callLuaLoadBuffer, (DWORD)&hkLuaLoadBuffer, loadbuff_prologue, sizeof(loadbuff_prologue));

    // Р В РІР‚в„ўР РЋРІР‚в„–Р В Р’В·Р РЋРІР‚в„–Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В РЎвЂўР РЋР вЂљР В РЎвЂ�Р В РЎвЂ“Р В РЎвЂ�Р В Р вЂ¦Р В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р РЋРЎвЂњР РЋР вЂ№ Р РЋРІР‚С›Р РЋРЎвЂњР В Р вЂ¦Р В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р РЋР вЂ№ Р РЋР С“ Р В РЎвЂ�Р РЋР С“Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂ�Р В Р вЂ¦Р РЋРІР‚в„–Р В РЎпїЅР В РЎвЂ� Р В РЎвЂ”Р В Р’В°Р РЋР вЂљР В Р’В°Р В РЎпїЅР В Р’ВµР РЋРІР‚С™Р РЋР вЂљР В Р’В°Р В РЎпїЅР В РЎвЂ�
    return callLuaLoadBuffer(L, buff, sz, name);
}

// Р В РІР‚пїЅР В РЎвЂўР В Р’В»Р В Р’ВµР В Р’Вµ Р В Р вЂ¦Р В РЎвЂ�Р В Р’В·Р В РЎвЂќР В РЎвЂўР РЋРЎвЂњР РЋР вЂљР В РЎвЂўР В Р вЂ Р В Р вЂ¦Р В Р’ВµР В Р вЂ Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р РЋРІР‚В¦Р РЋРЎвЂњР В РЎвЂќ Р В Р’В»Р РЋРЎвЂњР В Р’В°Р РЋРІвЂљВ¬Р В РЎвЂќР В РЎвЂ�
int __cdecl lua_load(void* L, lua_Reader reader, void* data, const char* chunkname)
{
    ...
    // Р В РЎСџР РЋР вЂљР В РЎвЂўР В Р вЂ Р В Р’ВµР РЋР вЂљР РЋР РЏР В Р’ВµР В РЎпїЅ Р В Р вЂ¦Р В Р’ВµР В РЎвЂўР В Р’В±Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂ�Р В РЎвЂ�Р В РЎпїЅР В РЎвЂўР РЋР С“Р РЋРІР‚С™Р РЋР Р‰ Р В РЎвЂ�Р В Р вЂ¦Р РЋР вЂ°Р В Р’ВµР В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р В РЎвЂ�
    if (chunkname && !lua_injection_list.empty())
    {
        ...
        for (const auto& lvm : lua_injection_list)
        {
                ...
                std::wstring(lvm.target_script.begin(), lvm.target_script.end())))
            {
                ...
                // Р В Р Р‹Р В РЎвЂўР В Р’В·Р В РўвЂ�Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В Р вЂ Р РЋР вЂљР В Р’ВµР В РЎпїЅР В Р’ВµР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р В Р’В±Р РЋРЎвЂњР РЋРІР‚С›Р В Р’ВµР РЋР вЂљ
                std::string temp_script(custom_size, '\0');
                ...
                // Р В Р Р‹Р В РЎвЂўР В Р’В·Р В РўвЂ�Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В Р вЂ¦Р В РЎвЂўР В Р вЂ Р РЋРЎвЂњР РЋР вЂ№ Р РЋР С“Р РЋРІР‚С™Р РЋР вЂљР РЋРЎвЂњР В РЎвЂќР РЋРІР‚С™Р РЋРЎвЂњР РЋР вЂљР РЋРЎвЂњ LoadS Р РЋР С“ Р В Р вЂ¦Р В Р’В°Р РЋРІвЂљВ¬Р В РЎвЂ�Р В РЎпїЅР В РЎвЂ� Р В РўвЂ�Р В Р’В°Р В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В РЎпїЅР В РЎвЂ�
                LoadS custom_load_s;
                ...
                // Р В РІР‚в„ўР РЋРІР‚в„–Р В Р’В·Р РЋРІР‚в„–Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р РЋР С“ Р В Р вЂ¦Р В РЎвЂўР В Р вЂ Р В РЎвЂўР В РІвЂћвЂ“ Р РЋР С“Р РЋРІР‚С™Р РЋР вЂљР РЋРЎвЂњР В РЎвЂќР РЋРІР‚С™Р РЋРЎвЂњР РЋР вЂљР В РЎвЂўР В РІвЂћвЂ“
    ...
    // Р В РІР‚в„ўР РЋРІР‚в„–Р В Р’В·Р РЋРІР‚в„–Р В Р вЂ Р В Р’В°Р В Р’ВµР В РЎпїЅ Р В РЎвЂўР РЋР вЂљР В РЎвЂ�Р В РЎвЂ“Р В РЎвЂ�Р В Р вЂ¦Р В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р РЋРЎвЂњР РЋР вЂ№ Р РЋРІР‚С›Р РЋРЎвЂњР В Р вЂ¦Р В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р РЋР вЂ№
    return call_lua_load(L, reader, data, chunkname);
}

// Р В Р’В¤Р РЋРЎвЂњР В Р вЂ¦Р В РЎвЂќР РЋРІР‚В Р В РЎвЂ�Р РЋР РЏ Р В РўвЂ�Р В Р’В»Р РЋР РЏ Р В РЎвЂўР РЋРІР‚РЋР В РЎвЂ�Р РЋР С“Р РЋРІР‚С™Р В РЎвЂќР В РЎвЂ� Р В Р’В·Р В Р’В°Р В РЎвЂ“Р РЋР вЂљР РЋРЎвЂњР В Р’В¶Р В Р’ВµР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р РЋРІР‚В¦ Р РЋР С“Р В РЎвЂќР РЋР вЂљР В РЎвЂ�Р В РЎвЂ”Р РЋРІР‚С™Р В РЎвЂўР В Р вЂ  (Р В Р вЂ Р РЋРІР‚в„–Р В Р’В·Р РЋРІР‚в„–Р В Р вЂ Р В Р’В°Р РЋРІР‚С™Р РЋР Р‰ Р В РЎвЂ”Р РЋР вЂљР В РЎвЂ� Р В Р вЂ Р РЋРІР‚в„–Р В РЎвЂ“Р РЋР вЂљР РЋРЎвЂњР В Р’В·Р В РЎвЂќР В Р’Вµ)
