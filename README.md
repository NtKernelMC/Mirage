# Mirage
- Lua инжектор для копий NEXT RP и UKRAINE GTA на базе mta sa 1.5.6-custom
- MTA:SA 1.6.0+ Official - Не поддерживается!
...
- Настроить Mirage.cfg под нужды целевого форка 1.6.0 в зависимости от особенностей его античита.
